...
public class MovieServletController extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
    ...
    logger.info("route : " + route);
    logger.info("req : " + req);
    logger.info("req : " + req.getParameter("titulo")); //era "nombre"
    switch(route) {
      case "add"-> {
        ...
        logger.info(titulo,anio,genero,descripcion,calificacion,estrellas,director);

        Pelicula newMovie = new Pelicula(titulo, anio, genero, descripcion, calificacion, estrellas, director);
       
        //Hardcodeo una peli
        Pelicula hardMovie = new Pelicula("hard", 2001, "hard", "hardhard", 88, (byte)3, "hard");
